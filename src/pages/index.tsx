  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Hotels Booking Application - Your premier tool for finding and booking unbeatable deals on all types of accommodations. We make your stay perfect, every time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1565953522043-baea26b83b7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhY2NvbW1vZGF0aW9ufGVufDB8fHx8MTY5NzAyOTQwM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Hotels Booking Application - Your premier tool for finding and booking unbeatable deals on all types of accommodations. We make your stay perfect, every time.`}
            </Text>
            <Box
