...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['business-owner', 'team-member', 'property-manager'],
    key: 'booking',
    tenantPath: [],
    userPath: [],
  },
  ...
  'availability.update.update': {
    roles: ['business-owner', 'property-manager'],
    key: 'availability',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'property-manager'];
